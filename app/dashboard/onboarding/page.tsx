...
export default async function OnboardingPage() {
	...
	return (
		<div className='w-full min-h-full bg-[#09090b] flex lg:items-center lg:justify-center font-sans'>
			<div className='w-full h-full max-w-md border border-zinc-900 bg-[#0c0c0e] p-8 rounded-none shadow-2xl'>
