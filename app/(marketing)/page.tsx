...
export default async function HomePage() {
	...
	return (
		<div className='w-full md:h-[calc(100vh-10rem)] bg-[#09090b] text-white font-sans selection:bg-emerald-500 selection:text-zinc-950 flex flex-col items-center justify-center'>
			{/* HERO SEKCIJA */}
			<main className='max-w-7xl mx-auto px-6 md:px-12 pt-24 pb-16 flex flex-col items-center justify-center text-center'>
